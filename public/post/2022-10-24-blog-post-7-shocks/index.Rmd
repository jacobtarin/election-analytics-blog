...
I decided to remove price drops just to focus on the idea of voters punishing incumbents for bad performance but it looks like gas price spikes don't really do anything significant for my model.